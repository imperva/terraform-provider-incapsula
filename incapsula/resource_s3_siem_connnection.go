...
func resourceS3SiemConnection() *schema.Resource {
	return &schema.Resource{
		Create: resourceS3SiemConnectionCreate,
		Read:   resourceS3SiemConnectionRead,
		Update: resourceS3SiemConnectionUpdate,
		Delete: resourceS3SiemConnectionDelete,
...
func resourceS3SiemConnectionCreate(d *schema.ResourceData, m interface{}) error {
	client := m.(*Client)
...
func resourceS3SiemConnectionRead(d *schema.ResourceData, m interface{}) error {
	client := m.(*Client)
...
func resourceS3SiemConnectionUpdate(d *schema.ResourceData, m interface{}) error {
	client := m.(*Client)
...
func resourceS3SiemConnectionDelete(d *schema.ResourceData, m interface{}) error {
	client := m.(*Client)
	ID := d.Id()
